...
import { acceptInviteAction } from "@/server/auth/invite-actions";
import type { AcceptState } from "@/server/auth/auth-types";
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-canvas px-4">
      <div className="w-full max-w-sm rounded-xl border border-border bg-surface p-8 shadow-overlay">
        ...
        <h1 className="text-xl font-semibold text-heading">Set your password</h1>
        <p className="mb-6 mt-1 text-sm text-body">
          Choose a password to activate your account (at least 12 characters).
        </p>
